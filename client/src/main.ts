...
// moves each into its own sprite module. drawCoaster's own coasterPath moved
// with it into render/sprites/rides.ts (private to that file); megaCoaster's
// pair stay here until drawMegaCoaster itself moves.
...
// ── Shops & Services ──
// tileHash moved to render/iso.ts (phase 4); imported directly, same signature.
